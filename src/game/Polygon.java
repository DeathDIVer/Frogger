...
class Polygon {
	...
	/**
	 * Checks if a certain point is contained within the polygon
	 * 
	...
	/**
	 * Calculates rotation for polygons
	 * 
	...
	/**
	 * Checks if polygons overlap with each other
	 * 
	 * @param other The other polygon
	 * @return Whether or not if the polygon collides with each other
	 */
